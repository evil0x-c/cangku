...
```
### vim的使用
>vim脱胎于vi，是linux中最受欢迎的文本编辑器，vim的基本功能就已经非常的强大，然而它还支持各种扩展，甚至被当做ide来使用，这里面先给大家介绍基本功能，其实说是基本功能但是也已经够用了。vim的功能太多了，这里我们直接看别人的文档，我选一些简单的操作给大家讲解[vim介绍](http://blog.csdn.net/donahue_ldz/article/details/17139361)
